import 'dart:io';
import 'package:agricultores_app/widgets/cultivos_orders/weightDropdown.dart';
...
class CultivosOrdersForm extends StatefulWidget {
  CultivosOrdersForm({this.images});
  final List<File> images;

  @override
  State<StatefulWidget> createState() => _CultivosOrderFormState(images);
}

class _CultivosOrderFormState extends State<CultivosOrdersForm> {
  final DateFormat formatter = DateFormat('dd-MM-yyyy');
  _CultivosOrderFormState(this._images);
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (value) => value.isEmpty
                      ? "El campo Precio no puede ser vacío"
                      : null,
                  maxLength: 30,
                ...
                TextFormField(
                  ...
                  validator: (value) => value.isEmpty
                      ? "El campo Área no puede ser vacío"
                      : null,
                  maxLength: 30,
                  decoration: _buildInputDecoration(
                      "Área en " + areaUnit),
